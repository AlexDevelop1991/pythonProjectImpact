...
def handle(msg):
    ...
    if content_type == 'text':
        ...
        if message == '/start':
            ...
            if not movies:
                bot.sendMessage(chat_id, 'You have not rates enough movies, we cannot generate recommendation for you')
            ...
            bot.sendMessage(chat_id, "I don't understand you command")
